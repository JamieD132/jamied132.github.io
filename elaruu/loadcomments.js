...
fetch('https://api.jamied132.is-a.dev/users/elaruu/comments?page='+pg).then(com=>com.json()).then(result=>{
        ...
        for(const com of comments){
            ...
            <div class="info">
                ...
                <div class="content">`+com.content.replace(/@([a-zA-Z0-9_-]+)/g, '<a href="/users/$1">@$1</a>').replace(/https:\/\/jamied132.is-a.dev([a-zA-Z0-9_-]+)/g, '<a href="/$1">https://jamied132.is-a.dev$1</a>').replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;")+`</div>
                <div>
            ...
            for(const rep of com.replies){
                ...
                <div class="info">
                    ...
                    <div class="content">`+rep.content.replace(/@([a-zA-Z0-9_-]+)/g, '<a href="/users/$1">@$1</a>').replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;")+`</div>
                    <div>
