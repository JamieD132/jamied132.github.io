...
fetch('https://api.jamied132.workers.dev/users/elaruu/comments').then(com=>com.json()).then(result=>{
        ...
        for(const com of comments){
            ...
            <a href="/users/`+com.username+`" id="comment-user" data-comment-user="`+com.username+`"><img class="avatar" src="`+pfp.pfp || '/elaruu/img/defaultpfp.png'+`" width="45" height="45"></a>
            <div class="info">
                <div class="name">
            ...
            for(const rep of com.replies){
                ...
                <div id="comments-`+id+`" class="comment" data-comment-id="`+id+`">
                <div class="actions-wrap"></div>
                <a href="/users/`+rep.username+`" id="comment-user" data-comment-user="`+rep.username+`"><img class="avatar" src="`+pfp.pfp || '/elaruu/img/defaultpfp.png'+`" width="45" height="45"></a>
                <div class="info">
                    <div class="name">
