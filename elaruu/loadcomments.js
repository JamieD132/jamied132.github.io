...
fetch('https://api.jamied132.workers.dev/users/elaruu/comments').then(com=>com.json()).then(result=>{
        ...
        comments.forEach((com)=>{
            ...
            <div class="info">
                ...
                <div>
                <span class="time" title="${com.date ? new Date(com.date).toLocaleDateString() : 'This is not a comment by a real user. It was archived from the original elaruu.'}">${com.date ? moment.unix(rep.date/1000).fromNow() : 'archived comment'}</span>
